 ...
 * USAGE:
 * <pre>
 *        KorisnikKlijent_2 client = new KorisnikKlijent_2();
 ...
 * @author NWTiS_4
 */
public class KorisnikKlijent_2 {
    ...
    public KorisnikKlijent_2(String icao, String dan) {
     ...
     */
    public <T> T dajLetoveAerodromaZaDan(Class<T> responseType, String korisnik, String lozinka) throws jakarta.ws.rs.ClientErrorException {
