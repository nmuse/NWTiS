...
@Path("dodajPodrucje")
@Controller
public class KorisnikKontroler_6 {
    ...
    public String dodajPodrucje() {
        ...
        String komanda = "GRANT " + korisnik + " " + sjednica
    ...
    private synchronized String izvrsiKomandu(String komanda, int port, String adresa) {
        try (Socket uticnica = new Socket(adresa, port);
            ...
            Logger.getLogger(KorisnikKontroler_6.class.getName()).log(Level.SEVERE, null, ex);
